...
<section class="services-vitanova">
    <div class="container">
        
        <div class="vitanova-header">
            <h1>Shërbime për të gjithë</h1>
            <p>Gjithçka që ju dhe familja juaj keni nevojë – në një vend.</p>
        </div>
            ...
            <?php foreach ($services as $service): ?>
                <div class="service-card">
                    ...
                    <div class="card-footer">
                         <a href="<?= $reserveBaseUrl ?>?service_id=<?= $service['id'] ?>" class="btn-text">
                            Rezervo Takim <i class="fas fa-arrow-right"></i>
                         </a>
                    </div>
                </div>
            <?php endforeach; ?>
